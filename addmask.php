...
<body class="hero-image">
    ...
    <section>
        <div class="container center">
            <form enctype="multipart/form-data" class="formoid-flat-green" style="background-color:#E4E4F4;font-size:14px;font-family:'Lato', sans-serif;color:#000;max-width:600px;min-width:150px" method="post" action="uploadaddmask.php">
                <div class="title">
                    <h2 style="margin-right: 27px;margin-left: 27px;">Add Mask</h2>
                </div>
                <div lass="element-name">
                    ...
                    <select name="category" style="width:50%;">
                        <option value="0" selected>Plain Mask</option>
                        <option value="1">Frequent Mask</option>
                        <option value="2">Popular Mask</option>
                    </select>
                    </span><br>
