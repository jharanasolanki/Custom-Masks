...
<?php
    ...
    $sql="select cat.id as prodid,cat.name as name,cat.price as price,cat.imagename as img,car.id as id from maskwishlist as car left join maskcatalog as cat on car.pid=cat.id where car.custid=$accountid;";
        ...
        while($row = $result->fetch_assoc()) 
        {
            ...
            <div class="right">
                <div class="row">
                    ...
                    <div class="delete" onclick="deleteWish($id,$prodid)"><img src="icons/delete.png"></div>
                </div>
                <div class="row">
