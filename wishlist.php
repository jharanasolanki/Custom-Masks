...
<?php
    ...
    $sql="select cat.id as prodid,cat.name as name,cat.price as price,cat.imagename as img,car.id as id from maskwishlist as car left join maskcatalog as cat on car.pid=cat.id and car.custid=$accountid;";
