...
<?php
    ...
    $sql="select cat.id as prodid,cat.name as name,cat.price as price,cat.imagename as img,car.id as id,car.qty as qty,car.total as total from maskscart as car left join maskcatalog as cat on car.productid=cat.id and car.accountid=$accountid;";
