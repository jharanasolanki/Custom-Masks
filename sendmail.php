...
while($row = $result->fetch_assoc()) {
    ...
    $mail->Body = "<h2>Special Discounts for you!</h2><h3>Hey $name!</h3><h4>Discount of :".$_POST['discount']."</h4>".$_POST["description"]." Visit our store: https://custommasks.herokuapp.com <br>"."<img src='cid:photo'>"; 
    try {
        $mail->send();
    } catch (Exception $e) {
